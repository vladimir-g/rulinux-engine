...
require_once(str_replace('\\\\','/',dirname(__FILE__)).'/../../classes/config.class.php');
...
SpawConfig::setStaticConfigItem('SPAW_ROOT', 'spaw2/');
...
SpawConfig::setStaticConfigItem('SPAW_ROOT', $_SERVER['DOCUMENT_ROOT'].'/spaw2/');
SpawConfig::setStaticConfigItem('SPAW_DIR', '/spaw2/');
...
SpawConfig::setStaticConfigItem('default_output_charset','utf8');
// theme 
SpawConfig::setStaticConfigItem('default_theme','spaw2');
// toolbarset 
SpawConfig::setStaticConfigItem('default_toolbarset','standard');
// stylesheet
SpawConfig::setStaticConfigItem('default_stylesheet','../../design/default/css/main.css');
// width 
...
SpawConfig::setStaticConfigItem(
  ...
  array(
    array(
      'dir'     => SpawConfig::getStaticConfigValue('SPAW_DIR').'',
    ...
    array(
      'dir'     => '/',
      'fsdir'   => SpawConfig::getStaticConfigValue('DOCUMENT_ROOT'), // optional absolute physical filesystem path
      'caption' => 'Files', 
      'params'  => array(
