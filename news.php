...
include 'themes/'.$theme.'/templates/news/nav_top.tpl.php';
...
for($i=0; $i<count($subsct);$i++)
{
	...
	if($subsection_id==$subsection_nav_id)
		...
		$selected_nav = '';
	include 'themes/'.$theme.'/templates/news/nav_middle.tpl.php';
}
include 'themes/'.$theme.'/templates/news/nav_bottom.tpl.php';

include 'themes/'.$theme.'/templates/news/top.tpl.php';
