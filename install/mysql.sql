...
CREATE TABLE users(id integer NOT NULL AUTO_INCREMENT, gid integer REFERENCES groups(id), nick varchar(255), password varchar(32), name varchar(255), lastname varchar(255), birthday timestamp, gender boolean, email varchar(128), show_email boolean, im varchar(255), show_im boolean, country varchar(255), city varchar(255), photo varchar(512), register_date timestamp, last_visit timestamp, captcha integer, left_block varchar(255), right_block varchar(255), additional text, news_on_page integer, comments_on_page integer, threads_on_page integer, show_avatars boolean, show_ua boolean, show_resp boolean, theme integer REFERENCES themes(id), gmt varchar(3), filters varchar(512), mark integer REFERENCES marks(id), banned boolean, sort_to boolean, PRIMARY KEY(id), UNIQUE(nick)) ENGINE=InnoDB;
