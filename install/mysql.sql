...
CREATE TABLE filters(id integer NOT NULL AUTO_INCREMENT, name varchar(255), text varchar(512), file varchar(128), class varchar(128), PRIMARY KEY(id), UNIQUE(name), UNIQUE(file)) ENGINE=InnoDB;
