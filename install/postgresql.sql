...
CREATE TABLE logs(id SERIAL, uid integer REFERENCES users(id), ip varchar(14), useragent varchar(512), timest timestamp without time zone, params text, message text, PRIMARY KEY(id));
