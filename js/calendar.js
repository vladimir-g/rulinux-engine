...
var daysColor="#B0C4DE";  //#708BD0
var bodyColor="#ffffff";
var dayColor="#ffffff"; //
var currentDayColor="#b7dcff"; //#333333 #708BD0 #B0C4DE #3399FF
var footColor="#e7e7e7";
var borderColor="#b7dcff"; //#333333

var titleFontColor = "#0000ff";
var daysFontColor = "#333333";
var dayFontColor = "#333333";
var currentDayFontColor = "#000000"; //#ffffff
var footFontColor = "#333333";

var calFormat = "yyyy-mm-dd"; //"yyyy/mm/dd";
...
var yxDays=new Array('Вс', 'Пн', 'Вт', 'Ср', 'Чт', 'Пт', 'Сб', 'Вс'); // Array('Воскресенье', 'Понедельник', 'Вторник', 'Среда', 'Четверг', 'Пятница', 'Суббота', 'Воскресенье');
...
function calTitle(d) {
  ...
  if (titleMode == 2) {
  	var dat = new Date();
    s="<tr align='center' bgcolor='"+titleColor+"'><td colspan='7'>\n<input type='text' id='hour' style='width:25%' value='"+dat.getHours()+"'>:<input type='text' id='minute' style='width:25%' value='"+dat.getMinutes()+"'>:<input type='text' id='seconds' style='width:25%' value='"+dat.getSeconds()+"'><table cellpadding='0' cellspacing='0' border='0'><tr align='center' valign='middle'><td align='right'>"+span1("title")+"<b>"+a1("titlea")+"'javascript:if(window.opener && !window.opener.closed && window.opener.moveYear) window.opener.moveYear(-10)'>&nbsp;&#171;</a>&nbsp;"+a1("titlea")+"'javascript:if(window.opener && !window.opener.closed && window.opener.moveYear) window.opener.moveYear(-1)'>&#139;&nbsp;</a></b>"+span2+"</td><td width='"+titleWidth+"'><b>"+span1("title")+yy+span2+"</b></td><td align='left'>"+span1("title")+"<b>"+a1("titlea")+"'javascript:if (window.opener && !window.opener.closed && window.opener.moveYear) window.opener.moveYear(1)'>&nbsp;&#155;</a>&nbsp;"+a1("titlea")+"'javascript:if (window.opener && !window.opener.closed && window.opener.moveYear) window.opener.moveYear(10)'>&#187;&nbsp;</a></b>"+span2+"</td></tr><tr align='center' valign='middle'><td align='right'>"+span1("title")+"<b>"+a1("titlea")+"'javascript:if (window.opener && !window.opener.closed && window.opener.prepMonth) window.opener.prepMonth("+d.getMonth()+")'>&nbsp;&#139;&nbsp;</a></b>"+span2+"</td><td width='"+titleWidth+"'><b>"+span1("title")+mm+span2+"</b></td><td align='left'>"+span1("title")+"<b>"+a1("titlea")+"'javascript:if (window.opener && !window.opener.closed && window.opener.nextMonth) window.opener.nextMonth("+d.getMonth()+")'>&nbsp;&#155;&nbsp;</a></b>"+span2+"</td></tr></table>\n</td></tr><tr align='center' bgcolor='"+daysColor+"'>";
  }
  else {
  	var dat = new Date();
    s="<tr align='center' bgcolor='"+titleColor+"'><td colspan='7'>\n<input type='text' id='hour' style='width:25%' value='"+dat.getHours()+"'>:<input type='text' id='minute' style='width:25%' value='"+dat.getMinutes()+"'>:<input type='text' id='seconds' style='width:25%' value='"+dat.getSeconds()+"'><table cellpadding='0' cellspacing='0' border='0'><tr align='center' valign='middle'><td>"+span1("title")+"<b>"+a1("titlea")+"'javascript:if(window.opener && !window.opener.closed && window.opener.moveYear) window.opener.moveYear(-1)'>&nbsp;&#171;</a>&nbsp;"+a1("titlea")+"'javascript:if (window.opener && !window.opener.closed && window.opener.prepMonth) window.opener.prepMonth("+d.getMonth()+")'>&#139;&nbsp;</a></b>"+span2+"</td><td width='"+titleWidth+"'><nobr><b>"+span1("title")+mm+" "+yy+span2+"</b></nobr></td><td>"+span1("title")+"<b>"+a1("titlea")+"'javascript:if (window.opener && !window.opener.closed && window.opener.nextMonth) window.opener.nextMonth("+d.getMonth()+")'>&nbsp;&#155;</a>&nbsp;"+a1("titlea")+"'javascript:if(window.opener && !window.opener.closed && window.opener.moveYear) window.opener.moveYear(1)'>&#187;&nbsp;</a></b>"+span2+"</td></tr></table>\n</td></tr><tr align='center' bgcolor='"+daysColor+"'>";
  }
